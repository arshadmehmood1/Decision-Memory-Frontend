...
import WhatsNewPanel, { WhatsNewButton } from '@/components/updates/WhatsNewPanel';
...
export function MarketingNavbar() {
    ...
    return (
        <>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <nav className="flex items-center justify-between">
                        ...
                        <div className="hidden md:flex items-center gap-4">
                            <WhatsNewButton onClick={() => setIsWhatsNewOpen(true)} />
                            <Link href="/login">
            ...
            {/* What's New Panel */}
            <WhatsNewPanel isOpen={isWhatsNewOpen} onClose={() => setIsWhatsNewOpen(false)} />
        </>
    );
}
